...
Mifasol est une application permettant de télécharger des OST de depuis le site [KHInsider](https://downloads.khinsider.com/). Fini la corvée de télécharger les pistes une par une ! ^^
...
* **Multiplateforme :** Fonctionne nativement sur macOS et Windows. (Théoriquement utilisable sur Linux aavec python)
...
### 🍏 Sur macOS
1. Téléchargez `Mifasol.app.zip` et dézipez-le.
2. Glissez `Mifasol.app` dans le dossier *Applications*.
*Lors du premier lancement, macOS bloquera l'application car elle provient d'un développeur non identifié. Faites un **Clic droit > Ouvrir** sur l'application, puis cliquez sur "Ouvrir" dans la boîte de dialogue. (Ou allez dans Réglages Systèmes > Confidentialité et sécurité > Ouvrir quand même.*
...
```bash
git clone [https://github.com/mathis-duclos/Mifasol.git](https://github.com/mathis-duclos/Mifasol.git)
cd Mifasol
...
*Je n'ai pas pu le tester sur des versions anterrieures de MacOS ou sur des Mac à puces Intel et ne suis donc pas capable d'affirmer s'il fonctionne correctement dessus*

###
Mifasol a été testé sur :
* Windows 11 Famille 24H2
* Windows 
*Je n'ai pas pu le tester sur des versions anterrieures de Windows et ne suis donc pas capable d'affirmer s'il fonctionne correctement dessus*
